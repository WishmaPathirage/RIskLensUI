...
const ChatBot = ({ variant = 'floating', context = null }) => {
    ...
    if (variant === 'embedded') {
        return (
            <div className="mt-8 pt-6 border-t border-slate-200">
                ...
                <div className="flex flex-col bg-white overflow-hidden w-full h-96 border border-slate-200 rounded-xl shadow-sm">
                    {/* Header */}
    ...
    return (
        <>
            {isOpen && (
                <div className="flex flex-col bg-white overflow-hidden fixed bottom-20 right-6 w-80 sm:w-96 h-[500px] shadow-2xl rounded-2xl border border-slate-200 z-50 animate-in slide-in-from-bottom-2">
                    {/* Header */}
                    <div className="bg-blue-600 p-4 text-white flex justify-between items-center z-10 shadow-sm relative">
                        <div className="flex items-center space-x-2">
                            <Bot className="h-5 w-5" />
